        ...
        <div className="asset-list">
          ...
          <div className="top" style={{ backgroundColor: "#CE5300" }}>
            ...
            <div className="d-flex flex-row bd-highlight mb-3">
              ...
              <button style={{ borderRadius: "12px", marginTop: "15px", backgroundColor: "antiquewhite", borderColor: "antiquewhite", color: "chocolate" }} type="button" name="search" className=" btn btn-outline-primary" onClick={this.searchBincard}><SearchOutlined /></button>
            </div>
              ...
              {bincards.length === 0 ?
                ...
                data?.map((bincard, index) => (
                  <tr key={bincard?.id}>
                    ...
                    <td>{bincard.date}</td>
                    <td>{bincard.nameOfArticle}</td>
                    <td>{bincard.purchaseOrderNumber}</td>
                    {/* <td>{bincard.receivedQuantity}</td> */}
                    <td>{bincard.issuedTo}</td>
                    <td>{bincard.issuedQuantity}</td>
                    <td>{bincard.dispatchedLocation}</td>
                    {/* <td>{bincard.balance}</td> */}

                    <td className="text-center"><Link to={`/update-bincard/${bincard.id}`} className="edit"><Edit /></Link></td>
